...
% Redefine chapter format to include chapter number and change color to Atlantic Blue
...
% Redefine section format to include section number and change color to Atlantic Blue
\titleformat{\section}[hang]
  {\normalfont\Large\bfseries\color{blue}} % Set color to Atlantic Blue
